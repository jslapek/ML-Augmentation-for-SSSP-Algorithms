...
namespace countmin_online_randomH {
...
struct Model {
    ...
    std::array<double, kNumFeatures> mean = {1.372058384951802, 3.7482075157100447, 0.041898267698230081, 0.52115637796295244, 1.147563663869005, 0.066769539639791403};
    std::array<double, kNumFeatures> scale = {0.48363132088917354, 1.2243411023214645, 0.033463793720960748, 0.28879286118706526, 0.15196187321675811, 0.051471500669125328};
    std::array<double, kNumFeatures> weights = {6.248859002071808, 0.65067444459092716, 9.3045629625564086, -0.54908442962689108, 2.0801982068089253, -3.6395666859586493};
    double bias = -4.7686408169708159;
    double threshold = 0.33624552867656371;
