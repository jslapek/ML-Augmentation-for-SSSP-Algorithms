...
namespace bound_offline_randomT {
...
struct Model {
    ...
    std::array<double, kNumFeatures> weights = {-0.057212721556425095, 0, 0, 0};
    double bias = 8.7587261199951172;
    double sigma = 0.067589670419692993;
