...
namespace bound_offline_randomE {
...
struct Model {
    ...
    std::array<double, kNumFeatures> weights = {-0.088529221713542938, 0, 0, 0};
    double bias = 17.871480941772461;
    double sigma = 0.036880869418382645;
