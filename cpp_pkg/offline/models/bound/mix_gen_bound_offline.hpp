...
namespace bound_offline_mix_gen {

struct Model {
    static constexpr int kNumFeatures = 4;

    std::array<double, kNumFeatures> mean = {6.9097687325845749, 1, 3, 4};
    std::array<double, kNumFeatures> scale = {0.002005989349384204, 1, 1, 1};
    std::array<double, kNumFeatures> weights = {-3.6251683235168457, 0, 0, 0};
    double bias = 11.373205184936523;
    double sigma = 2.8752479553222656;
