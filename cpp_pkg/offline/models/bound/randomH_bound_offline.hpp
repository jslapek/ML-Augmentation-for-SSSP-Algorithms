...
namespace bound_offline_randomH {
...
struct Model {
    ...
    std::array<double, kNumFeatures> weights = {-0.081786967813968658, 0, 0, 0};
    double bias = 13.00274658203125;
    double sigma = 0.11389506608247757;
