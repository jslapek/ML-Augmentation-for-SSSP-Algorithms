...
namespace bound_offline_RD {

struct Model {
    static constexpr int kNumFeatures = 4;

    std::array<double, kNumFeatures> mean = {7.1830455983931296, 1.137, 3.1274999999999999, 3.8147500000000001};
    std::array<double, kNumFeatures> scale = {0.76462149466600182, 0.34384734985165649, 0.36089298967977579, 0.38850024131265992};
    std::array<double, kNumFeatures> weights = {0.12659360468387604, -0.11245278269052505, 0.10254476964473724, 0.0067291641607880592};
    double bias = 3.0246095657348633;
    double sigma = 0.20142355561256409;
